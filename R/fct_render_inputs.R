...
#' @noRd
render_samples_plot_server <- function(output, element_id, geo_metadata = NULL, what="samples_sf", output_dir=NULL) {
  geo_map(output, element_id, geo_metadata, what, output_dir)
}

#' Server-side render logic for training area plot
#' @noRd
render_training_area_plot_server <- function(output, element_id, geo_metadata = NULL, what="training_area_sf", output_dir=NULL) {
  geo_map(output, element_id, geo_metadata, what, output_dir)
}

#' Server-side render logic for prediction area plot
#' @noRd
render_prediction_area_plot_server <- function(output, element_id, geo_metadata = NULL, what="prediction_area_sf", output_dir=NULL) {
  geo_map(output, element_id, geo_metadata, what, output_dir)
}
...
#' @noRd
render_geodist_plot_server <- function(output, element_id, geo_metadata = NULL, objective = c("Model and prediction", "Model only"), output_dir=NULL) {
