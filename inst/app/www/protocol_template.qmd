...
if (length(plot_files) > 0) {
	# Captions are built in R and passed in parallel to plot_files, so no
	# filename matching is needed here.
	...
	out <- vapply(
		seq_along(plot_files),
		function(i) {
			img_file <- normalizePath(plot_files[i], winslash = "/", mustWork = FALSE)
			paste0(
